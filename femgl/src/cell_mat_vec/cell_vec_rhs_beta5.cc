...
namespace FemGL_mpi
{
  ...
  template <int dim>
  double FemGL<dim>::vec_rhs_beta5(SimpleMatrix<double> &old_solution_u, SimpleMatrix<double> &old_solution_v,
				   SimpleMatrix<double> &phi_u_i_q, SimpleMatrix<double> &phi_v_i_q)
  {
    ...
    SimpleMatrix<double> u0_v0t(3,3) /*^*/,
                         u0t_u0(3,3) /*o*/, u0t_v0(3,3) /*s*/,
                         v0t_v0(3,3) /*x*/;

    SimpleMatrix<double>  v0_phi_ut_i_q(3,3), // ?5
