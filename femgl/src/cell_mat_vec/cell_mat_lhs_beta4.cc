...
namespace FemGL_mpi
{
  ...
  template <int dim>
  double FemGL<dim>::mat_lhs_beta4(SimpleMatrix<double> &old_solution_u, SimpleMatrix<double> &old_solution_v,
		                   ...
		                   SimpleMatrix<double> &phi_v_i_q,SimpleMatrix<double> &phi_v_j_q)
  {
    //block of assembly starts from here, all local objects in there will be release to save memory leak
                           ...
                           */
    SimpleMatrix<double>  phi_u_phi_ut(3,3) /*?3*/, phi_v_phi_vt(3,3), /*?4*/
                          phi_u_phi_vt(3,3) /*?1*/, phi_v_phi_ut(3,3); /*?2*/

    SimpleMatrix<double>  u0_u0t(3,3) /*s+*/, v0_v0t(3,3), /*h/*/
                          u0_v0t(3,3) /*ox*/, v0_u0t(3,3); /*^v+*/


    SimpleMatrix<double>            phi_u_i_q_u0t(3,3), /*o*/
                                    phi_u_i_q_v0t(3,3), /*^*/
                                    phi_v_i_q_v0t(3,3), /*^v*/
                                    phi_v_i_q_u0t(3,3), /*x*/
                                    /* ************** */
