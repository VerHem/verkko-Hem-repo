...
namespace FemGL_mpi
{
  ...
  template <int dim>
  double FemGL<dim>::mat_lhs_beta2(SimpleMatrix<double> &old_solution_u, SimpleMatrix<double> &old_solution_v,
		                   ...
		                   SimpleMatrix<double> &phi_v_i_q,SimpleMatrix<double> &phi_v_j_q)
  {
    ...
    SimpleMatrix<double>  phi_u_phi_ut(3,3),phi_v_phi_vt(3,3),
                          phi_phit_matrics_i_j_q(3,3);

    SimpleMatrix<double>    old_u_old_ut(3,3), old_v_old_vt(3,3);

    SimpleMatrix<double>            old_u_phi_ut_i_q(3,3),
