...
void SimpleMatrix<numbertype>::Tmmult(SimpleMatrix &C, const SimpleMatrix &B, const bool adding) const
{
  // a00*b00 + a10*b10 + a20*b20
  const double c00 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(0u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 0u]) * (B.mData[(1u *nCol) + 0u] ) 
                     + (this->mData[(2u *nCol) + 0u]) * (B.mData[(2u *nCol) + 0u]); 

  // a00*b01 + a10*b11 + a20*b21
  const double c01 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(0u *nCol) + 1u])    
                     + (this->mData[(1u *nCol) + 0u]) * (B.mData[(1u *nCol) + 1u] ) 
                     + (this->mData[(2u *nCol) + 0u]) * (B.mData[(2u *nCol) + 1u]); 

  // a00*b02 + a10*b12 + a20*b22
  const double c02 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(0u *nCol) + 2u])    
                     + (this->mData[(1u *nCol) + 0u]) * (B.mData[(1u *nCol) + 2u] ) 
                     + (this->mData[(2u *nCol) + 0u]) * (B.mData[(2u *nCol) + 2u]); 

  // a01*b00 + a11*b10 + a21*b20
  const double c10 = (this->mData[(0u *nCol) + 1u]) * (B.mData[(0u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 1u]) * (B.mData[(1u *nCol) + 0u]) 
                     + (this->mData[(2u *nCol) + 1u]) * (B.mData[(2u *nCol) + 0u]); 

  // a01*b01 + a11*b11 + a21*b21
  const double c11 = (this->mData[(0u *nCol) + 1u]) * (B.mData[(0u *nCol) + 1u])    
                     + (this->mData[(1u *nCol) + 1u]) * (B.mData[(1u *nCol) + 1u]) 
                     + (this->mData[(2u *nCol) + 1u]) * (B.mData[(2u *nCol) + 1u]); 

  // a01*b02 + a11*b12 + a21*b22
  const double c12 = (this->mData[(0u *nCol) + 1u]) * (B.mData[(0u *nCol) + 2u])    
                     + (this->mData[(1u *nCol) + 1u]) * (B.mData[(1u *nCol) + 2u]) 
                     + (this->mData[(2u *nCol) + 1u]) * (B.mData[(2u *nCol) + 2u]); 

  // a02*b00 + a12*b10 + a22*b20
  const double c20 = (this->mData[(0u *nCol) + 2u]) * (B.mData[(0u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 2u]) * (B.mData[(1u *nCol) + 0u]) 
                     + (this->mData[(2u *nCol) + 2u]) * (B.mData[(2u *nCol) + 0u]); 

  // a02*b01 + a12*b11 + a22*b21
  const double c21 = (this->mData[(0u *nCol) + 2u]) * (B.mData[(0u *nCol) + 1u])    
                     + (this->mData[(1u *nCol) + 2u]) * (B.mData[(1u *nCol) + 1u]) 
                     + (this->mData[(2u *nCol) + 2u]) * (B.mData[(2u *nCol) + 1u]); 

  // a02*b02 + a12*b12 + a22*b22
  const double c22 = (this->mData[(0u *nCol) + 2u]) * (B.mData[(0u *nCol) + 2u])    
