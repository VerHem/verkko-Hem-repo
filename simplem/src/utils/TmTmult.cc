...
void SimpleMatrix<numbertype>::TmTmult(SimpleMatrix &C, const SimpleMatrix &B, const bool adding) const
{
  // a00*b00 + a10*b01 + a20*b02
  const double c00 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(0u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 0u]) * (B.mData[(0u *nCol) + 1u] ) 
                     + (this->mData[(2u *nCol) + 0u]) * (B.mData[(0u *nCol) + 2u]); 

  // a00*b10 + a10*b11 + a20*b12
  const double c01 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(1u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 0u]) * (B.mData[(1u *nCol) + 1u] ) 
                     + (this->mData[(2u *nCol) + 0u]) * (B.mData[(1u *nCol) + 2u]); 

  // a00*b20 + a10*b21 + a20*b22
  const double c02 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(2u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 0u]) * (B.mData[(2u *nCol) + 1u] ) 
  ...
  const double c10 = (this->mData[(0u *nCol) + 1u]) * (B.mData[(0u *nCol) + 0u])    
                     ...
                     + (this->mData[(2u *nCol) + 1u]) * (B.mData[(0u *nCol) + 2u]); 

  // a01*b10 + a11*b11 + a21*b12
  const double c11 = (this->mData[(0u *nCol) + 1u]) * (B.mData[(1u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 1u]) * (B.mData[(1u *nCol) + 1u]) 
                     + (this->mData[(2u *nCol) + 1u]) * (B.mData[(1u *nCol) + 2u]); 

  // a01*b20 + a11*b21 + a21*b22
  const double c12 = (this->mData[(0u *nCol) + 1u]) * (B.mData[(2u *nCol) + 0u])    
  ...
  const double c20 = (this->mData[(0u *nCol) + 2u]) * (B.mData[(0u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 2u]) * (B.mData[(0u *nCol) + 1u]) 
                     + (this->mData[(2u *nCol) + 2u]) * (B.mData[(0u *nCol) + 2u]); 

  // a02*b10 + a12*b11 + a22*b12
  const double c21 = (this->mData[(0u *nCol) + 2u]) * (B.mData[(1u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 2u]) * (B.mData[(1u *nCol) + 1u]) 
                     + (this->mData[(2u *nCol) + 2u]) * (B.mData[(1u *nCol) + 2u]); 

  // a02*b20 + a12*b21 + a22*b22
  const double c22 = (this->mData[(0u *nCol) + 2u]) * (B.mData[(2u *nCol) + 0u])    
                     + (this->mData[(1u *nCol) + 2u]) * (B.mData[(2u *nCol) + 1u]) 
