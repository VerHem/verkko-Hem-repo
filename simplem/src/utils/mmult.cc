...
void SimpleMatrix<numbertype>::mmult(SimpleMatrix &C, const SimpleMatrix &B, const bool adding) const
{
  // a00*b00 + a01*b10 + a02*b20
  const double c00 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(0u *nCol) + 0u])    
                     + (this->mData[(0u *nCol) + 1u]) * (B.mData[(1u *nCol) + 0u] ) 
                     + (this->mData[(0u *nCol) + 2u]) * (B.mData[(2u *nCol) + 0u]); 

  // a00*b01 + a01*b11 + a02*b21
  const double c01 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(0u *nCol) + 1u])    
                     + (this->mData[(0u *nCol) + 1u]) * (B.mData[(1u *nCol) + 1u] ) 
                     + (this->mData[(0u *nCol) + 2u]) * (B.mData[(2u *nCol) + 1u]); 

  // a00*b02 + a01*b12 + a02*b22
  const double c02 = (this->mData[(0u *nCol) + 0u]) * (B.mData[(0u *nCol) + 2u])    
                     + (this->mData[(0u *nCol) + 1u]) * (B.mData[(1u *nCol) + 2u] ) 
  ...
  const double c10 = (this->mData[(1u *nCol) + 0u]) * (B.mData[(0u *nCol) + 0u])    
                     ...
                     + (this->mData[(1u *nCol) + 2u]) * (B.mData[(2u *nCol) + 0u]); 

  // a10*b01 + a11*b11 + a12*b21
  const double c11 = (this->mData[(1u *nCol) + 0u]) * (B.mData[(0u *nCol) + 1u])    
                     + (this->mData[(1u *nCol) + 1u]) * (B.mData[(1u *nCol) + 1u]) 
                     + (this->mData[(1u *nCol) + 2u]) * (B.mData[(2u *nCol) + 1u]); 

  // a10*b02 + a11*b12 + a12*b22 
  const double c12 = (this->mData[(1u *nCol) + 0u]) * (B.mData[(0u *nCol) + 2u])    
  ...
  const double c20 = (this->mData[(2u *nCol) + 0u]) * (B.mData[(0u *nCol) + 0u])    
                     + (this->mData[(2u *nCol) + 1u]) * (B.mData[(1u *nCol) + 0u]) 
                     + (this->mData[(2u *nCol) + 2u]) * (B.mData[(2u *nCol) + 0u]); 

  // a20*b01 + a21*b11 + a22*b21
  const double c21 = (this->mData[(2u *nCol) + 0u]) * (B.mData[(0u *nCol) + 1u])    
                     + (this->mData[(2u *nCol) + 1u]) * (B.mData[(1u *nCol) + 1u]) 
                     + (this->mData[(2u *nCol) + 2u]) * (B.mData[(2u *nCol) + 1u]); 

  // a20*b02 + a21*b12 + a22*b22
  const double c22 = (this->mData[(2u *nCol) + 0u]) * (B.mData[(0u *nCol) + 2u])    
